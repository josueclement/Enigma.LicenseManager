...
| FEATURE-004 | Prepare 1.2.0 release (build-config, deps, xUnit v3, docs) | TODO | docs/plan/FEATURE-004.md |
| - PHASE01   | Build-settings consolidation (`Directory.Build.props` + `.editorconfig`) | TODO | (in FEATURE-004.md) |
| - PHASE02   | `Directory.Packages.props` overhaul + non-Avalonia dependency refresh | TODO | (in FEATURE-004.md) |
